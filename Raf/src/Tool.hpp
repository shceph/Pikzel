...
namespace App
{
	...
	public:
		...
		constexpr static void SetCurrentColorToColor1() { selected_color_slot = COLOR_SLOT_1; current_color = &color_1; }
		constexpr static void SetCurrentColorToColor2() { selected_color_slot = COLOR_SLOT_2; current_color = &color_2; }

		constexpr static int GetSelectedColorSlot() { return selected_color_slot; }

		constexpr static ToolType GetToolType() { return current_tool_type; }
		static void SetToolType(ToolType type)  { current_tool_type = type; }

		constexpr static int GetBrushRadius()	{ return brush_radius; }
		static void SetBrushRadius(int radius)	{ brush_radius = radius; }
